...
public:
  ...
  FileEntry();
  FileEntry(FileIndex index, QString name, DirectoryEntry* parent);
  ...
  void addOrigin(OriginID origin, QDateTime fileTime, QStringView archive, int order);
  ...
  bool isFromArchive(QString archiveName = "") const;
