...
private:
  ...
  FileEntryPtr insert(QStringView fileName, FilesOrigin& origin, QDateTime fileTime,
                      QStringView archive, int order, DirectoryStats& stats);

  FileEntryPtr insert(env::File& file, FilesOrigin& origin, QStringView archive,
  ...
  DirectoryEntry* getSubDirectory(QStringView name, bool create, DirectoryStats& stats,
  ...
  struct Context;
  static void onDirectoryStart(Context* cx, QStringView path);
  static void onDirectoryEnd(Context* cx, QStringView path);
  static void onFile(Context* cx, QStringView path, QDateTime ft);
